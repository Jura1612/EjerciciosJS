...
Escribe una función llamada calculadora(operacion, num1, num2) 
que reciba una operación ("suma", "resta", "multiplicacion", "division")
...
function calculadora(operacion, num1, num2) {
    switch (operacion) {
        ...
        case "division":
            if (num2 === 0) {
                return "Para reflexionar esa divición entre 0";
            }
            return num1 / num2
        default:
